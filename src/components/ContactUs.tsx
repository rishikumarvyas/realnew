  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 -mt-24">
          ...
          <div className="glass-effect bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-lg p-8 text-center transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <p className="text-gray-600">
              General Inquiries: contact@homeyatra.in<br />
          ...
          <div className="glass-effect bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-lg p-8 text-center transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <h3 className="font-bold text-xl mb-3 text-gray-800">Business Hours</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            {formSubmitted ? (
              <div className="bg-green-50 border border-green-100 rounded-xl p-6 flex items-center animate-fade-in">
                ...
                <div>
                  <h3 className="font-semibold text-green-800 text-lg">Thank you for your message!</h3>
                  <p className="text-green-700">We have received your inquiry and will get back to you soon.</p>
                </div>
              </div>
            ) : (
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl h-full">
            <div className="h-full min-h-[500px] bg-gradient-to-br from-blue-50 to-gray-100 flex flex-col items-center justify-center p-10 relative">
              ...
              <div className="relative z-10 text-center max-w-md mx-auto">
                ...
                <h3 className="text-3xl font-bold mb-4 text-gray-800">Visit Our Office</h3>
                <p className="text-gray-700 mb-8 text-lg">
                  Come visit us at our Delhi headquarters to meet our team in person. We're conveniently located in Connaught Place, easily accessible by metro and other public transportation.
                </p>
          ...
          <div className="grid gap-6">
            {[
              { 
                ...
                answer: "You can list your property by creating an account and using our 'Post Property' feature. The process is simple and guided, requiring details about your property, photos, and pricing information."
              },
              { 
                question: "What documents do I need to buy a property?", 
                answer: "For purchasing a property, you'll need identity proof, address proof, PAN card, income documents like salary slips or ITR, and property documents. Our agents can provide specific guidance based on your situation."
              },
              { 
                question: "How does Homeyatra verify listed properties?", 
                answer: "We have a stringent verification process where our team physically visits properties, verifies ownership documents, and checks legal clearances before listings are approved on our platform."
              },
              { 
                question: "Do you charge any fees for property visits?", 
                answer: "No, property visits arranged through Homeyatra are completely free of charge. We believe in helping you find the perfect home without any hidden costs."
              }
            ].map((faq, index) => (
      ...
      <div className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: "url('/api/placeholder/1920/600')" }}></div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="backdrop-blur-sm bg-white/10 rounded-3xl p-16 border border-white/20 shadow-2xl">
            <h2 className="text-4xl font-extrabold mb-6 text-white">Ready to find your dream home?</h2>
            <p className="text-xl mb-10 text-blue-100 max-w-2xl mx-auto">
              Our property experts are standing by to help you navigate the real estate market in India.
            </p>
