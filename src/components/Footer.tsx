            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <Link
                  ...
                  className="text-gray-800 hover:text-white transition duration-200"
                >
                  Buy
                </Link>
              </li>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
            {[
              ...
              <button
                ...
                className="group flex flex-col items-center p-3 rounded-lg bg-blue-50/50 hover:bg-blue-100/70 transition-all duration-300 border border-gray-600 hover:border-orange-600/50 cursor-pointer"
              ...
              >
                ...
                <span className="text-gray-800 text-xs mt-1 group-hover:text-blue-600 transition-colors duration-200 text-center">
                  {city.state}
                </span>
              </button>
            ))}
