...
export default function AboutUs() {
  ...
  useEffect(() => {
    ...
    const timers = [
      setTimeout(() => setIsVisible(prev => ({ ...prev, banner: true })), 300),
      setTimeout(() => setIsVisible(prev => ({ ...prev, mission: true })), 600),
      setTimeout(() => setIsVisible(prev => ({ ...prev, stats: true })), 900),
      setTimeout(() => setIsVisible(prev => ({ ...prev, team: true })), 1200),
      setTimeout(() => setIsVisible(prev => ({ ...prev, history: true })), 1500),
      setTimeout(() => setIsVisible(prev => ({ ...prev, testimonials: true })), 1800),
      setTimeout(() => setIsVisible(prev => ({ ...prev, contact: true })), 2100)
    ];
    ...
    <div className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl group">
      ...
      <div className="p-6 border-t-2 border-blue-100">
        ...
        <div className="mt-4 flex space-x-3">
          ...
          <a href="#" className="text-gray-500 hover:text-blue-600 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm3.92 6.12h-2.61c-.2 0-.35.05-.35.21V9.5h2.96v2H12.96v7H9.76v-7h-2v-1.5h2v-1c0-1.5 1-2.5 2.5-2.5h3.42v1.33z" clipRule="evenodd" />
            </svg>
          </a>
        </div>
      </div>
  ...
  const TestimonialCard = ({ quote, author, position, image }) => (
    <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
      <div className="flex items-center mb-6">
        <div className="mr-4">
          <img src={image} alt={author} className="w-16 h-16 rounded-full object-cover shadow-md" />
        </div>
        <div>
      ...
      <div className="relative flex-grow">
        <svg className="absolute -top-4 -left-2 w-8 h-8 text-blue-200" fill="currentColor" viewBox="0 0 32 32">
  ...
  const PropertyCard = ({ title, description, price, image, tag, tagColor }) => (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl transform hover:-translate-y-2 group">
      <div className="relative h-64">
        ...
        <div className={`absolute top-4 right-4 ${tagColor} text-white px-3 py-1 rounded-md font-medium`}>{tag}</div>
      </div>
      <div className="p-6">
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Hero Banner */}
      <div className={`banner-section relative h-screen max-h-[700px] overflow-hidden transition-all duration-1000 ${animateClass('banner')}`}>
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-6">
            <div className="animate-fadeIn">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 max-w-2xl leading-tight">Welcome to <span className="text-blue-300">Home</span>Yatra</h1>
              <p className="text-xl md:text-2xl text-white max-w-xl mb-8">Your trusted partner in finding the perfect home across India</p>
      ...
      {/* Our Mission */}
      <section className={`mission-section py-16 md:py-24 container mx-auto px-6 transition-all duration-1000 transform ${animateClass('mission')}`}>
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-16 mb-10 md:mb-0">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-4">OUR PURPOSE</span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-8">Our Mission</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              At HomeYatra, we believe everyone deserves to find their perfect home. Our mission is to simplify the real estate journey by providing transparent information, personalized guidance, and innovative technology that empowers our clients to make confident decisions.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Founded in 2015, we've helped thousands of families and individuals discover properties that feel like home across all major cities in India. Our approach combines deep local expertise with cutting-edge technology to create a seamless home-finding experience.
            </p>
          </div>
      ...
      {/* Stats Section */}
      <section className={`stats-section py-16 md:py-24 bg-gradient-to-r from-blue-50 to-white transition-all duration-1000 transform ${animateClass('stats')}`}>
        <div className="container mx-auto px-6">
          <span className="block text-center text-blue-600 font-semibold mb-4">THE NUMBERS SPEAK</span>
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-16">Our Impact</h2>
      ...
      {/* Our Team */}
      <section className={`team-section py-16 md:py-24 container mx-auto px-6 transition-all duration-1000 transform ${animateClass('team')}`}>
        <div className="max-w-4xl mx-auto text-center mb-16">
          <span className="inline-block px-4 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-4">THE EXPERTS</span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Meet Our Leadership</h2>
          <p className="text-lg text-gray-600">Our diverse team of real estate experts is dedicated to helping you find your dream home</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <TeamMember 
            name="Rajiv Sharma" 
      ...
      {/* Our Journey */}
      <section className={`history-section py-16 md:py-24 bg-gradient-to-b from-blue-900 to-blue-800 text-white transition-all duration-1000 transform ${animateClass('history')}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <span className="inline-block px-4 py-1 bg-blue-700 text-blue-100 rounded-full text-sm font-semibold mb-4">OUR STORY</span>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Journey</h2>
            <p className="text-lg text-blue-100">From a small startup to India's leading real estate platform</p>
          </div>
            ...
            <div className="space-y-16">
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right">
                  <div className="bg-blue-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:bg-blue-700 transform hover:-translate-y-1">
                    <h3 className="text-2xl font-bold text-blue-300 mb-3">2015</h3>
                    <p className="text-blue-100 text-lg">HomeYatra was founded in Mumbai with a vision to transform real estate experiences in India</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
                  <div className="bg-blue-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:bg-blue-700 transform hover:-translate-y-1">
                    <h3 className="text-2xl font-bold text-blue-300 mb-3">2018</h3>
                    <p className="text-blue-100 text-lg">Expanded to 10 major cities across India and launched our innovative property matching technology</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right">
                  <div className="bg-blue-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:bg-blue-700 transform hover:-translate-y-1">
                    <h3 className="text-2xl font-bold text-blue-300 mb-3">2020</h3>
                    <p className="text-blue-100 text-lg">Pioneered virtual property tours during the pandemic, helping families find homes safely</p>
                  </div>
                </div>
                <div className="hidden md:block w-6 h-6 animate-pulse bg-blue-400 rounded-full absolute left-1/2 transform -translate-x-1/2 border-4 border-blue-800"></div>
                <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0"></div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
                  <div className="bg-blue-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:bg-blue-700 transform hover:-translate-y-1">
                    <h3 className="text-2xl font-bold text-blue-300 mb-3">Today</h3>
                    <p className="text-blue-100 text-lg">Serving 25+ cities with an ecosystem of services that make finding your dream home simpler than ever</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Testimonials */}
      <section className={`testimonials-section py-16 md:py-24 bg-gray-50 transition-all duration-1000 transform ${animateClass('testimonials')}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-4">CLIENT STORIES</span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">What Our Clients Say</h2>
            <p className="text-lg text-gray-600">Hear from families who found their dream homes with HomeYatra</p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-4">PREMIUM LISTINGS</span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Featured Properties</h2>
            <p className="text-lg text-gray-600">Discover some of our most exclusive properties available right now</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl transform hover:-translate-y-2">
              <div className="relative h-64">
                <img src="/api/placeholder/600/400" alt="Luxury Villa" className="w-full h-full object-cover" />
                <div className="absolute top-4 right-4 bg-blue-600 text-white px-3 py-1 rounded-md font-medium">Premium</div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Luxury Villa in Bandra</h3>
                <p className="text-gray-600 mb-4">A stunning 4BHK villa with ocean views and modern amenities</p>
                <div className="flex justify-between items-center">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl transform hover:-translate-y-2">
              <div className="relative h-64">
                <img src="/api/placeholder/600/400" alt="Modern Apartment" className="w-full h-full object-cover" />
                <div className="absolute top-4 right-4 bg-green-600 text-white px-3 py-1 rounded-md font-medium">New</div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Modern Apartment in Powai</h3>
                <p className="text-gray-600 mb-4">A spacious 3BHK apartment with panoramic city views</p>
                <div className="flex justify-between items-center">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl transform hover:-translate-y-2">
              <div className="relative h-64">
                <img src="/api/placeholder/600/400" alt="Penthouse" className="w-full h-full object-cover" />
                <div className="absolute top-4 right-4 bg-purple-600 text-white px-3 py-1 rounded-md font-medium">Featured</div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Luxurious Penthouse in Juhu</h3>
                <p className="text-gray-600 mb-4">A 5BHK penthouse with private terrace and swimming pool</p>
                <div className="flex justify-between items-center">
      ...
      {/* Contact Section */}
      <section className={`contact-section py-16 md:py-24 bg-gradient-to-r from-blue-600 to-blue-500 text-white transition-all duration-1000 transform ${animateClass('contact')}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <span className="inline-block px-4 py-1 bg-blue-700 text-blue-100 rounded-full text-sm font-semibold mb-4">GET IN TOUCH</span>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Find Your Dream Home?</h2>
            <p className="text-lg text-blue-100">Our team of experts is ready to help you begin your home journey</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 text-center hover:bg-opacity-15 transition-all duration-300 flex flex-col items-center">
              ...
              <p className="mb-4">Our team is available Monday-Saturday, 9am-6pm</p>
              <a href="tel:+918000123456" className="text-xl font-semibold hover:text-blue-200 transition-colors">+91 8000 123 456</a>
            </div>
            ...
            <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 text-center hover:bg-opacity-15 transition-all duration-300 flex flex-col items-center">
              ...
              <a href="mailto:info@homeyatra.com" className="text-xl font-semibold hover:text-blue-200 transition-colors">info@homeyatra.com</a>
            </div>
      ...
      <section className="py-16 md:py-24 bg-gray-900 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">Start Your Home Journey Today</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
            Join thousands of satisfied homeowners who found their perfect space with HomeYatra
          </p>
