  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-16 mb-8 px-2 animate-fade-in-up">
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold mb-2 tracking-wide text-[#C5B483]">
          GET IN TOUCH
        </h2>
        <p className="text-gray-600 max-w-xl mx-auto text-base sm:text-lg">
          ...
          free to contact us. Our site representative will give you a call back.
        </p>
      </div>
      <div className="bg-gradient-to-br from-[#f8f6f1] to-[#f3f1ea] rounded-2xl shadow-xl border border-[#ece6d9] p-0.5">
        <form
          onSubmit={handleSubmit}
          className="bg-white rounded-2xl p-6 sm:p-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-end"
        >
          <div className="relative">
            ...
            <label
              htmlFor="name"
              className="absolute left-2 top-3 text-gray-500 text-base transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:-top-4 peer-focus:text-xs peer-focus:text-[#C5B483] bg-white px-1 pointer-events-none"
            >
              Name*
            </label>
          </div>
          ...
          <div className="col-span-1 md:col-span-3 flex items-center mt-2">
            ...
            >
              Yes, I would like to receive updates & promotions from HomeYatra
              Properties.
            </Label>
          </div>
          ...
          {success && (
            <div className="col-span-1 md:col-span-3 mt-4 text-center animate-fade-in text-green-600 font-semibold">
              Thank you! We have received your details and will contact you
              soon.
            </div>
          )}
        </form>
...
const BuilderPropertyDetail = () => {
  ...
  const propertyDetails: PropertyDetails = {
    ...
    description:
      "A shoreline sanctuary shaped by the timeless dance of earth and sea, Godrej Skyshore emerges with quiet elegance along Mumbai's western coast. Where the rhythm of the waves meets architectural finesse, strength and serenity converge - creating a legacy address poised to reshape the landscape of Versova.",
    address: {
  ...
  const calculateEMI = () => {
    ...
    const principal =
      Number(loanAmount) - (Number(loanAmount) * advancePayment) / 100;
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 border-b md:border-b-0 md:border-r border-gray-200">
                  ...
                  <p className="text-xl font-bold text-gray-900">
                    {propertyDetails.configurations}
                  </p>
                </div>
                <div className="text-center p-4 border-b md:border-b-0 md:border-r border-gray-200">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <svg
                        className="w-5 h-5 text-[#C5B483] mt-0.5 mr-3"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        Internal walls with premium quality blocks
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        Anti-skid tiles in bathrooms & balconies
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
        ...
        {activeTab === "LOCATION" && (
          <div className="mx-auto">
            ...
            <p className="text-gray-700 mb-8">
              Well-planned roads and diverse transport options make India's
              cleanest city easily accessible from every direction
            </p>

            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              <h3 className="font-bold mb-4">ADDRESS</h3>
              <p className="text-gray-700">
                {propertyDetails.address.full}
                <br />
                {propertyDetails.address.area}, {propertyDetails.address.city}{" "}
                {propertyDetails.address.pincode}
              </p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {((Number(loanAmount) * advancePayment) / 100).toFixed(
                          0,
                        )}
                      </span>
                    </div>
          ...
          <div className="mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Shaping this space with intention. Behold three levels as they
                flow into one another, from grounded greens to active spaces,
                all the way up to quiet heights cradled by the sky and light.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 mb-16">
              {filteredAmenities.map((amenity, index) => (
                ...
                >
                  ...
                  <span className="text-xs text-[#C5B483] font-medium">
                    {amenity.category}
                  </span>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {propertyDetails.images.amenities.map((image, index) => (
                  <div
                    key={index}
                    className="group relative overflow-hidden rounded-xl aspect-[4/3] shadow-md hover:shadow-xl transition-shadow duration-300"
                  >
                    <img
                      src={image}
                ...
                {[
                  {
                    ...
                    description:
                      "State-of-the-art fitness equipment and sports facilities",
                    icon: "🏋️‍♂️",
                  },
                  {
                    title: "Professional Management",
                    description:
                      "Dedicated staff for maintenance and assistance",
                    icon: "👥",
                  },
                  {
                    title: "Safety & Security",
                    description:
                      "24/7 security with modern surveillance systems",
                    icon: "🔒",
                  },
                  {
                    title: "Green Spaces",
                  ...
                  },
                  {
                    ...
                    description:
                      "Regular social activities and community gatherings",
                    icon: "🎉",
                  },
                  {
                    title: "Convenience",
                    description:
                      "Easy access to all amenities within the complex",
                    icon: "✨",
                  },
                ].map((feature, index) => (
                  <div
...
const getIconPath = (amenityName: string) => {
  ...
  const iconPaths: { [key: string]: string } = {
    "Kids' Play Area":
      "M21.17 2.06L13.31 10H12V8.69L19.94 0.83L21.17 2.06zM12 14c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z",
    "Cricket Net":
      "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14H6v-2h6v2zm4-4H6v-2h10v2zm0-4H6V7h10v2z",
    "Jogging Track":
    ...
    "Squash Court":
      "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 7h3V7h-3V5h5v14h-5v-2h3v-3h-3v-4z",
    Library:
