...
const featuredProperties: PropertyCardProps[] = [
  ...
  },
  {
    ...
    area: 650,
    image:
      "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",
  },
  {
    id: "prop4",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 group text-center border border-gray-100">
            ...
            <p className="text-gray-600">
              Every property is thoroughly verified by our team to ensure
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 group text-center border border-gray-100">
            ...
            <p className="text-gray-600">
              Our streamlined process ensures you can find, buy, or rent
              properties with minimal delay.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 group text-center border border-gray-100">
            ...
            <p className="text-gray-600">
              Our experienced team provides end-to-end assistance throughout
        ...
        <div className="max-w-5x1 mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-16 border border-white/50 shadow-2xl">
            ...
            <p className="text-xl mb-10 text-gray-700 max-w-2xl mx-auto">
              List your property with Homeyatra and reach thousands of potential
              buyers and renters all across India.
            </p>
            <Button
              size="lg"
