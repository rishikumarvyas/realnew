...
export default function EnhancedPrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 font-sans transition-opacity duration-1000 overflow-hidden">
      ...
      <div
        className={`fixed bottom-8 right-8 bg-blue-600 text-white px-6 py-4 rounded-lg shadow-xl z-50 flex items-center space-x-3 transition-all duration-500 transform ${
          showNotification
      ...
      >
        ...
        <button
          className="ml-4 hover:bg-blue-700 p-1 rounded-full"
      ...
      <div className="relative overflow-hidden h-screen lg:h-96">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute top-20 left-20 w-64 h-64 rounded-full bg-blue-300 opacity-20 blur-3xl animate-pulse"></div>
          <div
            className="absolute bottom-20 right-20 w-96 h-96 rounded-full bg-blue-400 opacity-20 blur-3xl animate-pulse"
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 h-full flex flex-col justify-center text-white text-center">
          <div
            className={`inline-block mx-auto mb-6 p-3 rounded-full bg-blue-500/30 backdrop-blur-md transition-all duration-1000 ${
          ...
          >
            <button className="bg-white text-blue-600 font-medium px-6 py-3 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center space-x-2 mx-auto">
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 relative z-20">
        ...
        >
          <div className="flex flex-col md:flex-row items-center md:space-x-6 mb-6">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-blue-600 mb-2 text-center md:text-left">
                Your Data Protection Rights
              </h3>
              <p className="text-blue-600 text-lg text-center md:text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {[
              ...
              <div
                key={index}
                className="bg-blue-50 rounded-xl p-4 flex items-center justify-center space-x-2 transition-all duration-300 hover:bg-blue-100 hover:shadow-md"
              >
                {item.icon}
        ...
        <div
          id="rights-section"
          className={`animation-trigger bg-gradient-to-br from-blue-100 to-blue-100 rounded-2xl shadow-lg p-8 mb-16 transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                icon: <X className="h-6 w-6 text-blue-600" />,
              },
              {
                title: "Opt-Out",
                description:
              ...
              >
                <div className="flex items-center space-x-4 mb-3">
                  <div className="bg-blue-100 p-2 rounded-lg">{card.icon}</div>
        ...
        >
          ...
          <div className="max-w-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="w-full pl-10 px-4 py-3 border border-blue-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300"
            ...
            <div className="mb-6">
              ...
              <input
                type="text"
                className="w-full px-4 py-3 border border-blue-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300"
            ...
            <div className="flex justify-center">
              <button className="bg-gradient-to-r from-blue-500 to-blue-400 hover:from-blue-600 hover:to-blue-600 text-white font-medium px-8 py-4 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center space-x-2">
