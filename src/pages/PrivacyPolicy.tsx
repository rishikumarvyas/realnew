...
import { Shield, Lock, Eye, Database, Bell, ChevronDown, User, Mail, MessageSquare, ArrowRight, Info, Check, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 font-sans transition-opacity duration-1000 overflow-hidden">
      ...
      <div className="relative overflow-hidden h-screen lg:h-96">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 rounded-full bg-indigo-400 opacity-20 blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 relative z-20">
        ...
        >
          <div className="flex flex-col md:flex-row items-center md:space-x-6 mb-6">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-indigo-900 mb-2 text-center md:text-left">Your Data Protection Rights</h3>
              <p className="text-indigo-600 text-lg text-center md:text-left">Transparency, Security, and Control</p>
            </div>
          </div>
          <p className="text-gray-700 mb-4 text-lg">
            At HomeYatra, we are dedicated to helping you find your dream home while respecting and protecting your privacy. 
            This Privacy Policy explains how we collect, use, and protect your personal information when you use our website 
            and services.
          </p>
          <p className="text-gray-700 text-lg">
            This policy applies to all users of HomeYatra, including property buyers, sellers, renters, landlords, 
            and real estate professionals. By using our services, you consent to the practices described in this policy.
          </p>
          
          {/* Key principles cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {[
              { icon: <Info className="h-6 w-6 text-indigo-600" />, text: "Transparency" },
              { icon: <Lock className="h-6 w-6 text-indigo-600" />, text: "Security" },
              { icon: <Check className="h-6 w-6 text-indigo-600" />, text: "Control" },
              { icon: <Shield className="h-6 w-6 text-indigo-600" />, text: "Protection" }
            ].map((item, index) => (
              <div 
                key={index} 
          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              >
                ...
                <ChevronDown className={`text-indigo-600 transition-transform duration-300 ${
        ...
        <div 
          ...
          className={`animation-trigger bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl shadow-lg p-8 mb-16 transition-all duration-1000 ${
            animatedElements['rights-section'] ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
          }`}
        >
          <h3 className="text-2xl md:text-3xl font-bold text-indigo-900 mb-8 text-center">Your Rights</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              {
                title: "Access and Correction",
                description: "You have the right to access and update your personal information stored in our systems.",
              ...
              {
                title: "Deletion",
                description: "You can request the deletion of your personal information in certain circumstances.",
                icon: <X className="h-6 w-6 text-indigo-600" />
              },
              {
                title: "Opt-Out",
                description: "You can opt out of marketing communications and certain data processing activities.",
              ...
              >
                <div className="flex items-center space-x-4 mb-3">
                  ...
                  <h4 className="text-lg font-semibold text-indigo-800">{card.title}</h4>
                </div>
        ...
        <div 
          ...
          className={`animation-trigger bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-8 transition-all duration-1000 ${
            animatedElements['contact-section'] ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
          }`}
        >
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-indigo-900 mb-2">Privacy Questions?</h3>
            <p className="text-indigo-600">We're here to help with any privacy concerns you may have</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-indigo-800 mb-1">Subject</label>
              <input 
                type="text" 
