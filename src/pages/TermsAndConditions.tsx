    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 font-sans transition-opacity duration-1000">
      ...
      <div className="relative overflow-hidden h-96">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            className="absolute bottom-20 right-20 w-96 h-96 rounded-full bg-purple-400 opacity-20 blur-3xl animate-pulse"
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 h-full flex flex-col justify-center text-white text-center">
          ...
          >
            ...
            HomeYatra platform. By accessing our services, you agree to be bound
            by these terms.
          </p>
        </div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 relative z-20">
        ...
        >
          ...
          <p className="text-gray-700 mb-4 text-lg">
            These Terms and Conditions govern your use of the HomeYatra platform
            and services. Our mission is to provide a transparent, efficient,
            and trustworthy marketplace for real estate transactions in India,
            connecting property seekers with property owners and real estate
            professionals.
          </p>
          <p className="text-gray-700 text-lg">
            By creating an account, listing a property, or using any of our
        ...
        <div
          ...
          className={`animation-trigger bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl shadow-lg p-8 mb-16 transition-all duration-1000 ${
            animatedElements["agreement-section"]
              ? "translate-y-0 opacity-100"
              : "translate-y-20 opacity-0"
          }`}
        >
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-gray-700">
                  I confirm that I have read, understood, and agree to be bound
                  by HomeYatra's Terms and Conditions and Privacy Policy. I
                  understand that these terms form a legally binding agreement
                  between myself and HomeYatra.
                </p>
              </div>
            </div>
          </div>
